...
if is_hist_match==1:
    ...
    cImPath_str=cwd+'\imgs\src_imgs\moran-content.jpg'
    sImPath_str=cwd+'\imgs\src_imgs\kanagawa.jpg'

if is_hist_match==2:
    cImPath_str=cwd+'\imgs\src_imgs\moran-content.jpg'
    sImPath_str=cwd+'\imgs\src_imgs\modified_kanagawa_set2.jpg'

genImOutputPath_str=cwd+f'\imgs\\final_imgs\\result_{iterations}_{is_hist_match}_set2.jpg'
