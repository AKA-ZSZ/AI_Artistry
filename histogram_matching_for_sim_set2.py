...
SOURCE_IMAGE = f"{cwd}\imgs\\final_imgs\\result_{iterations}_1_set2.jpg" # change iterations here, 1 means the generated image used color profile of original content image
REFERENCE_IMAGE = f"{cwd}\imgs\src_imgs\moran-content.jpg"
MASK_IMAGE = "mask.jpg"
...
def main():
    ...
    cv2.imwrite(f"{cwd}\imgs\\final_imgs\\result_{iterations}_1_post_set2.jpg", output_image)


    # calculate hist and cdf for the generated pic
    image_generated = cv2.imread(cv2.samples.findFile(f"{cwd}\imgs\\final_imgs\\result_{iterations}_1_post_set2.jpg"))
