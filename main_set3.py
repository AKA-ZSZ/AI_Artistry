...
if is_hist_match==1:
    ...
    sImPath_str=cwd+'\imgs\src_imgs\Red_Blue_and_Yellow_style.jpg'

if is_hist_match==2:
    cImPath_str=cwd+'\imgs\src_imgs\starrynight.jpg'
    sImPath_str=cwd+'\imgs\src_imgs\modified_Red_Blue_and_Yellow_style.jpg'

genImOutputPath_str=cwd+f'\imgs\\final_imgs\\result_{iterations}_{is_hist_match}_set3.jpg'
